...
echo "=== 省赛赛前检查：${mode} ==="
check_file "/home/yuanbao/bobac3_ws/src/bobac3_navigation/maps/reicom.yaml" "省赛地图配置"
check_file "/home/yuanbao/bobac3_ws/src/bobac3_navigation/maps/reicom.pgm" "省赛地图图像"
check_file "/home/yuanbao/bobac3_ws/src/service_group_mission/config/service_group_waypoints.yaml" "省赛点位"
check_file "/home/yuanbao/.ros/face_encodeing.npz" "人脸编码库"
check_file "/home/yuanbao/ros_workspace/models/sensevoice/model.int8.onnx" "中文语音识别模型"
check_file "/home/yuanbao/ros_workspace/models/melo_tts/model.int8.onnx" "中文语音合成模型"
check_file "/home/yuanbao/ros_workspace/models/raicom_world.pt" "巡检视觉模型"
