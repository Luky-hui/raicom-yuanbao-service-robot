...
def main():
    ...
    face_database = "/home/yuanbao/.ros/face_encodeing.npz"
    ...
    if face_check["ready"]:
        ...
        face_check["administrator_label_present"] = "庄朋晖" in face_check["labels"]
        face_check["ready"] = face_check["administrator_label_present"]
    report["checks"]["face_database"] = face_check
    report["software_ready"] = report["software_ready"] and face_check["ready"]

    model_paths = [
        "/home/yuanbao/ros_workspace/models/raicom_world.pt",
        "/home/yuanbao/ros_workspace/models/sensevoice/model.int8.onnx",
        "/home/yuanbao/ros_workspace/models/melo_tts/model.int8.onnx",
    ]
    model_check = {
