...
MODEL_ROOT = "/home/yuanbao/.gazebo/models/rei_2025raicom"
...
def main():
    ...
    parser.add_argument("--config-file", default="/home/yuanbao/bobac3_ws/src/service_group_mission/config/service_group_waypoints.yaml")
